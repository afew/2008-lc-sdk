...
HRESULT CD3DEnum::EnumerateDevices( D3DAdapterInfo* pAdapterInfo, 
...
HRESULT CD3DEnum::EnumerateDeviceCombos( D3DDeviceInfo* pDeviceInfo, 
                                               CArrayList* pAdapterFormatList )
{
    ...
    for( UINT iaf = 0; iaf < pAdapterFormatList->Count(); iaf++ )
    {
        ...
        for( UINT ibbf = 0; ibbf < backBufferFormatArrayCount; ibbf++ )
        {
            ...
            for( UINT iiw = 0; iiw < 2; iiw++)
            {
                ...
                pDeviceCombo->pDSMSConflictList = new CArrayList( CArrayList::AL_VALUE, sizeof( D3DDSMSConflict ) );
                pDeviceCombo->pVertexProcessingTypeList = new CArrayList( CArrayList::AL_VALUE, sizeof( VertexProcessingType ) );
...
void CD3DEnum::BuildDepthStencilFormatList( D3DDeviceCombo* pDeviceCombo )
{
...
void CD3DEnum::BuildMultiSampleTypeList( D3DDeviceCombo* pDeviceCombo )
{
...
//       multisample types.
void CD3DEnum::BuildDSMSConflictList( D3DDeviceCombo* pDeviceCombo )
{
...
//       and app to the given D3DDeviceCombo.
void CD3DEnum::BuildVertexProcessingTypeList( D3DDeviceInfo* pDeviceInfo, 
...
void CD3DEnum::BuildPresentIntervalList( D3DDeviceInfo* pDeviceInfo, 
                                                D3DDeviceCombo* pDeviceCombo )
{
    const UINT piArray[] = { 
