...
protected:
	...
	Lcxmo::lsTlPkT	m_vPkLc	;			// Picking Triangle from Local
	BOOL			m_bClck	;
...
public:
	...
	void			CreateField(Lcxmo::MpInf*, Lcxmo::MpEnv*, Lcxmo::lsMpTex*);			// Create Field
...
protected:
	...
	INT			PickPosition(CLcxmBlc**			pBlock
							, Lcxmo::lsTlPkT*	pPickInf	// Picking Triangle
