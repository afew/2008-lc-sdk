...
public:
	...
	DWORD					m_dRscIcon			;								// Program Icon Id
	DWORD					m_dRscMenu			;								// Resouce Menu Id
	DWORD					m_dRscAccel			;								// Resouce Accelator Id

	DWORD					m_dRscDevice		;								// Device Id
	DWORD					m_dRscToggle		;								// Toggle Id
	DWORD					m_dRscExit			;								// Exit Id
