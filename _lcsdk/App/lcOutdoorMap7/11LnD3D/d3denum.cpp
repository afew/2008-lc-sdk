// Implementation of the CD3DEnum class.
//
////////////////////////////////////////////////////////////////////////////////
...
HRESULT CD3DEnum::EnumerateDevices( CD3DEnum::D3DAdapterInfo* pAdapterInfo, 
...
HRESULT CD3DEnum::EnumerateDeviceCombos( CD3DEnum::D3DDeviceInfo* pDeviceInfo, 
											   CArrayList* pAdapterFormatList )
{
	...
	for( UINT iaf = 0; iaf < pAdapterFormatList->Count(); iaf++ )
	{
		...
		for( UINT ibbf = 0; ibbf < backBufferFormatArrayCount; ibbf++ )
		{
			...
			for( UINT iiw = 0; iiw < 2; iiw++)
			{
				...
				pDeviceCombo->pDSMSConflictList = new CArrayList( AL_VALUE, sizeof( CD3DEnum::D3DDSMSConflict ) );
				pDeviceCombo->pVertexProcessingTypeList = new CArrayList( AL_VALUE, sizeof( CD3DEnum::VertexProcessingType ) );
...
void CD3DEnum::BuildVertexProcessingTypeList( CD3DEnum::D3DDeviceInfo* pDeviceInfo, 
													CD3DEnum::D3DDeviceCombo* pDeviceCombo )
{
...
void CD3DEnum::BuildPresentIntervalList( CD3DEnum::D3DDeviceInfo* pDeviceInfo, 
											   CD3DEnum::D3DDeviceCombo* pDeviceCombo )
{
	const UINT piArray[] = { 
