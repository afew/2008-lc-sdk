...
public:
	...
	ILcxmT::VtxIdx*	m_pFce;
	ILcxmT::VtxSpl*	m_pVtx;
	INT*			m_pVtt;
	
	ILcxmT::lsMpTex	m_vTex;					// Tiling Texture Name and Pointer List
...
public:
	...
	void	LayerSetup(ILcxmT::lsMpTex* pTxLst);
	void	LayerAdd(ILcxmT::MpTex* pTex);
