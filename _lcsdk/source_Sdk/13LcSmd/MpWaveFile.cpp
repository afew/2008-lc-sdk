// Implementation of the CMpWaveFile class.
//
////////////////////////////////////////////////////////////////////////////////
...
HRESULT CMpWaveFile::Open( LPTSTR strFileName, WAVEFORMATEX* pwfx, DWORD dwFlags )
{
	HRESULT hr;
...
// Desc: copy data to CMpWaveFile member variable from memory

HRESULT CMpWaveFile::OpenFromMemory( BYTE* pbData, ULONG ulDataSize, 
...
// Name: CMpWaveFile::ReadMMIO()
// Desc: Support function for reading from a multimedia I/O stream.
//       m_hmmio must be valid before calling.  This function uses it to
//       update m_ckRiff, and m_pwfx. 

HRESULT CMpWaveFile::ReadMMIO()
{
...
// Name: CMpWaveFile::GetSize()
// Desc: Retuns the size of the read access wave file 

DWORD CMpWaveFile::GetSize()
{
	return m_dwSize;
}
...
// Name: CMpWaveFile::ResetFile()
// Desc: Resets the internal m_ck pointer so reading starts from the 
//       beginning of the file again 

HRESULT CMpWaveFile::ResetFile()
{
	if( m_bIsReadingFromMemory )
	{
		m_pbDataCur = m_pbData;
...
HRESULT CMpWaveFile::Read( BYTE* pBuffer, DWORD dwSizeToRead, DWORD* pdwSizeRead )
{
	if( m_bIsReadingFromMemory )
	{
		if( m_pbDataCur == NULL )
...
// Name: CMpWaveFile::Close()
// Desc: Closes the wave file 

HRESULT CMpWaveFile::Close()
{
	if( m_dwFlags == WAVEFILE_READ )
	{
		mmioClose( m_hmmio, 0 );
...
// Name: CMpWaveFile::WriteMMIO()
// Desc: Support function for reading from a multimedia I/O stream
//       pwfxDest is the WAVEFORMATEX for this new wave file.  
//       m_hmmio must be valid before calling.  This function uses it to
//       update m_ckRiff, and m_ck.  

HRESULT CMpWaveFile::WriteMMIO( WAVEFORMATEX *pwfxDest )
{
...
// Name: CMpWaveFile::Write()
// Desc: Writes data to the open wave file

HRESULT CMpWaveFile::Write( UINT nSizeToWrite, BYTE* pbSrcData, UINT* pnSizeWrote )
{
	UINT cT;
